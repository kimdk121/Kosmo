		...
		// ------------------------------------------------------------
		var weekMsg = {
			"월요일" : "월요일은 9시에 회의가 있는 날 입니다. 보고 준비해 주십시오."
			,"화요일" : "화요일은 대 청소날입니다."
			,"수요일" : "수요일은 봉사활동날 입니다."
			,"목요일" : "부서별 회식이 있습니다."
		...
		// ------------------------------------------------------------
		// 2차원 Array 객체 생성하고 변수 scheduleMsg에 저장하기.
		// ------------------------------------------------------------
		var scheduleMsg = [
			[ "2021-07-20 ", "오늘은 36도 까지 올라가는 긴급 상태입니다. 주의요망"]
		...
		// ------------------------------------------------------------
		// 1차원 Array 객체 생성하고 변수 goldenSaying에 저장하기
		// ------------------------------------------------------------
		var goldenSaying = [
			"노력은 배신하지 않는다."
			,"피할수 없으면 즐겨라"
			,"당신이 보낸 헛된 하루는 어제 죽은 자가 그토록 바라던 내일이었다"
